    ...
    <section className="py-20 md:py-28">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <Tabs defaultValue={tabs[0].value} className="mt-8">
          ...
          <div className="mx-auto mt-8 max-w-screen-xl rounded-2xl bg-muted/70 p-6 lg:p-16 border border-border/50 shadow-sm">
            {tabs.map((tab) => (
              <TabsContent
                key={tab.value}
                value={tab.value}
              ...
              >
                <div className="flex flex-col gap-5">
                  ...
                  <h3 className="text-3xl font-bold tracking-tight lg:text-4xl xl:text-5xl">
                    {tab.content.title}
                  </h3>
