...
const Navbar1 = () => {
  ...
  return (
    <motion.div 
      ...
      className="fixed top-0 left-0 right-0 z-50 flex justify-center w-full py-6 px-4 pointer-events-none"
    >
      <div className="flex items-center justify-between px-6 py-3 bg-white/80 backdrop-blur-md border border-gray-200 rounded-full shadow-lg w-full max-w-3xl relative z-10 pointer-events-auto">
        ...
        >
          <Link
            href="/start"
            className="inline-flex items-center justify-center px-5 py-2 text-sm bg-black text-white rounded-full hover:bg-gray-800 transition-colors cursor-pointer"
          >
            Comenzar Proyecto
          </Link>
        </motion.div>
